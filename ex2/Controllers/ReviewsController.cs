...
namespace ex2.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ReviewsController(ex2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index2(string query)
        {
            if (query != null)
            {
                ...
                return _context.Review != null ?
                            PartialView(await q.ToListAsync()) :
                            Problem("Entity set 'ex2Context.Review'  is null.");
            }
            else
            {
                return _context.Review != null ?
                        PartialView(await _context.Review.ToListAsync()) :
                        Problem("Entity set 'ex2Context.Review'  is null.");
            }
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,UserName,Comment,Rate,Time")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserName,Comment,Rate,Time")] Review review)
        {
            if (id != review.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ex2Context.Review'  is null.");
            }
            var review = await _context.Review.FindAsync(id);
            if (review != null)
            {
